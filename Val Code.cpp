...
//(2)Function Definition (Initialization)
void CalcAverage()
{
    ...
    cout << '\n';
    cout << setw(18) << "Week of";

    cout << setw(16) << "Gallons";
    ...
    for (int i = 0; i < weeks; ++i)
    {
        ...
        cout << setw(18) << startingdate[i];
        cout << setw(16) << totalGallons[i];
        cout << setw(16) << totalMiles[i];
        cout << setw(16) << totalMiles[i] / totalGallons[i] << endl;
    }
    //(12) Display totals row
    cout << setw(18) << "Totals"
        << setw(16) << aGallons
        << setw(16) << aMiles
        << setw(16) << aMiles / aGallons << endl;

    // (13) Display Overall Average row
    cout << setw(18) << "Average"
        << setw(16) << aGallons / 4
        << setw(16) << aMiles / 4 << endl;
}
